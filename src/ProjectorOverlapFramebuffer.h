...
namespace pro_cal {
	...
	public:
		//---------------------------------------------------------------------
		ProjectorOverlapFramebuffer(sgct::Engine* engine);
	...
	private:
		...
		bool CreateProgram(const std::string& programName, const std::string& vertexShaderPath, const std::string& fragmentShaderPath);
